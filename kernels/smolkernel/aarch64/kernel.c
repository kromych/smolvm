...
void start_kernel()
{
    ...
    printf_("Hello, world, from EL %lu!\n", arm_reg_current_el() >> 2);
    ...
    printf_("ID_AA64MMFR0_EL1:\t0x%016lx\n", arm_reg_id_aa64mmfr0_el1());
    printf_("ID_AA64MMFR1_EL1:\t0x%016lx\n", arm_reg_id_aa64mmfr1_el1());
    printf_("ID_AA64MMFR2_EL1:\t0x%016lx\n", arm_reg_id_aa64mmfr2_el1());
